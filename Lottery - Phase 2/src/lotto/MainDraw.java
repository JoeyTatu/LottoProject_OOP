...
/**
 * @filename MainDraw.java (Phase 2)
...
public class MainDraw {
    ...
    public MainDraw(int[] secret, int[][] num, int correctL1, int correctL2, int correctL3, String input, Integer n) {
        this.secret = secret;
        this.num = num;
    ...
    public String printDetailsMain(){
        //Prints amount of matching numbers
        return "In the Lotto MAIN draw," +
