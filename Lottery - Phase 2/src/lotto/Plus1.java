...
public class Plus1{
    ...
    public Plus1(int[] secret, int[][] num, int correctL1, int correctL2, int correctL3, String input, Integer n) {
        this.secret = secret;
        this.num = num;
    ...
    public String printDetailsP1(){
        return "In the Lotto PLUS 1 draw," +
