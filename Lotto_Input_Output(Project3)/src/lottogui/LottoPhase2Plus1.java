...
public class LottoPhase2Plus1{
    ...
    public LottoPhase2Plus1(int[] secret, int[][] num, int correctL1, int correctL2, int correctL3, String input, Integer n) {
        this.secret = secret;
        this.num = num;
    ...
    public void computeCheckInputP1(){
